...
def open_admin_panel():
    ...
    button_generate_reports.grid(row=1, column=0, pady=5)
...
def open_staff_panel():
    ...
    button_process_billing.grid(row=1, column=1, pady=5)

    button_handle_maintenance = tk.Button(staff_panel, text="Handle Maintenance")
    button_handle_maintenance.grid(row=2, column=0, pady=5)

    button_manage_inventory = tk.Button(staff_panel, text="Manage Inventory")
    button_manage_inventory.grid(row=2, column=1, pady=5)
...
label_frame = tk.LabelFrame(login_window, text="Login", font=("Helvetica", 16), padx=20, pady=20, borderwidth=2, relief="groove")
